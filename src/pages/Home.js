        ...
        <div>
          ...
          <div className='about'>
            ...
            <div className="about_text" >
              ...
              <h3 style={{ textAlign: "center", color: "#7d0a00" }}>श्री कामना पूर्ति अनुष्ठान केंद्र: जीवन की कामनाओं को पूरा करने का संगठन </h3>
              <p style={{ fontSize: "19.5px", padding: "10px", fontWeight: "600" }}>
          ...
          <div className=" card_list">
            <div className='title my-5 text-center'>
              <h3 style={{ color: "#7d0a00", fontWeight: "bold" }}> <u> पूजा सूची: संपर्क करने के लिए पूजा सेवाओं की सूची देखें </u></h3>
            </div>
